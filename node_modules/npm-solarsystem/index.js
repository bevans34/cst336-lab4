...
module.exports.getMars = function Mars() {
    const mars = { // This image had to be replaced.
...
module.exports.getJupiter = function Jupiter() {
    const jupiter = { // This image had to be replaced.
        image:'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Jupiter_OPAL_2024.png/1024px-Jupiter_OPAL_2024.png',
...
module.exports.getSaturn = function Saturn() {
    const saturn = { // I think this image works better for my site.
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Saturn_during_Equinox.jpg/1920px-Saturn_during_Equinox.jpg', // 'https://solarsystem.nasa.gov/system/resources/detail_files/14379_IMG003379.jpg',
...
module.exports.getPluto = function Pluto() {
    const pluto = { // This image had to be replaced
